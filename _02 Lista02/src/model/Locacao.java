...
public class Locacao {
    ...
    public Locacao(long id, Date dataLocacao, Time horaLocacao, Date dataDevolucao, Time horaDevolucao, int quilometragem, double valorCalcao, double valorLocacao, boolean devolvido) {
        this.id = id;
